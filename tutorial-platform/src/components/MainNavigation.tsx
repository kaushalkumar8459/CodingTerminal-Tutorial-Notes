    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-end gap-2 px-1">
        <details className="group relative">
          <summary className="flex cursor-pointer list-none items-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-cyan-50 sm:text-sm">
            Tools
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
          ...
          <div className="absolute right-0 z-20 mt-1 min-w-44 overflow-hidden rounded-lg border border-slate-200 bg-white py-1 shadow-lg">
            <Link
