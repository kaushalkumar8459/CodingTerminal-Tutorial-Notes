# Day 017 — Notification System — Solution Guide

## Approach

Start with the smallest working implementation for **Notification System**, then add production concerns incrementally.
