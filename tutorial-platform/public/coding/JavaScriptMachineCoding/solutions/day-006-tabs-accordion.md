# Day 006 — Tabs & Accordion — Detailed Solution

## What to Build

Keyboard navigation and single/multi expand.

## Core Implementation / Algorithm

```js
const open=new Set(); function toggle(id){open.has(id)?open.delete(id):open.add(id);}
```
