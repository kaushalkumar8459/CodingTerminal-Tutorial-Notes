# Day 010 — File Upload — Detailed Solution

## What to Build

Validation, progress, cancellation.

## Core Implementation / Algorithm

```js
const controller=new AbortController(); fetch("/upload",{method:"POST",body:file,signal:controller.signal});
```
